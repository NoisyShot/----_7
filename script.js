...
let b1 = 5 % 3 ; // 2
let b2 = 3 % 5 ; // 3
let b3 = 5 + '3' ; // 8 не правильно!!! + сделал 3 числом и в итоге получилось числовое значение 53!
let b4 = '5' - 3 ; // nan не правильно!!! выполнилось вычисление
let b5 = 75 + 'кг'; // 75кг
...
let v = cylinderDiameter * cylinderHeight; // 40
console.log(v);
...
let a = 10;
let b = 2;
console.log(a+b, a-b, a*b, a/b); //12 8 20 5
...
console.log (60*60*24*30); // для апреля, июня, сентября и ноября
